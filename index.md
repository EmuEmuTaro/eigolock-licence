...
NGSL 1.2を基に作成された本アプリの学習データ部分は、CC BY-SA 4.0の条件に従って利用できます。このライセンスは、本アプリのプログラム、画面デザイン、ロゴ、商標その他の独自部分には適用されません。
...
## ConTrack: Context Tracking Dataset
...
ConTrackを基に作成された本アプリの学習データ部分は、CC BY-SA 4.0の条件に従って利用できます。このライセンスは、本アプリのプログラム、画面デザイン、ロゴ、商標その他の独自部分には適用されません。

ConTrackは、明示または黙示を問わず、いかなる保証も伴わない現状有姿で提供されています。Googleは、同データセットの利用により生じた直接的または間接的な損害について責任を負わない旨を表明しています。

---

## ライセンスの適用範囲

上記のCreative Commonsライセンスは、それぞれのデータセットおよびそれらを基に作成された学習データ部分に適用されます。

本アプリのソースコード、画面デザイン、ロゴ、商標、独自に作成したコンテンツその他の部分には、別途明示されない限り、これらのライセンスは適用されません。

各データセットの提供者、著作者および権利者は、本アプリまたはその運営者を推薦、後援または承認しているものではありません。

各データセットおよびそれらを基に作成された学習データ部分については、本アプリの利用規約と異なる定めがある場合、ここに記載された各Creative Commonsライセンスの条件が優先して適用されます。
